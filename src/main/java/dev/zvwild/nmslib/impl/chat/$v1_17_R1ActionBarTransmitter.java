 ...
 */
public final class $v1_17_R1ActionBarTransmitter implements ActionBarTransmitter {
    ...
    public $v1_17_R1ActionBarTransmitter() {
        ...
        try {
            ...
            packetConstructor = Class.forName("net.minecraft.network.protocol.game.PacketPlayOutChat")
