...
public final class $v1_8_R3PacketTransmitter implements PacketTransmitter {
    ...
    public $v1_8_R3PacketTransmitter() {
        ...
        try {
            ...
            sendPacketMethod = playerConnectionClass.getDeclaredMethod("sendPacket", Class.forName("net.minecraft.server.v1_8_R3.Packet"));
